        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../personnel">Teacher Management</a></li>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="status" required>
                ...
                <option value="ประจำแผนกวิชา">ประจำแผนกวิชา</option>
                <option value="ประจำแผนก">ประจำแผนก</option>
              </select>
            </div>
