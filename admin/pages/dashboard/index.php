<?php 
    ...
    $sql = "SELECT * FROM `articles` ORDER BY `articles`.`ar_id` ";
    $result = $conn->query($sql);
    $rowsarticles = $result->num_rows;

    $sql = "SELECT id FROM `contacts` ORDER BY `id` ";
    $result = $conn->query($sql);
    $rowscontacts = $result->num_rows;
